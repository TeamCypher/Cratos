...
export function HistoryEmptyState({ isSearchEmpty, onClearFilters }: HistoryEmptyStateProps) {
  if (isSearchEmpty) {
    return (
      <div className="w-full py-20 flex flex-col items-center justify-center text-center bg-card/20 rounded-3xl border border-dashed border-white/10">
  ...
  return (
    <div className="w-full py-24 flex flex-col items-center justify-center text-center bg-card/20 rounded-3xl border border-dashed border-white/10">
