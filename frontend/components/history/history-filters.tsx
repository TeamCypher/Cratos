...
export function HistoryFilters({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 mb-8 bg-card/30 p-4 border border-white/5 rounded-2xl">
      ...
      <div className="relative w-full md:max-w-xs flex-1">
        ...
        <Input
          ...
          className="pl-9 h-10 bg-black/40 border-white/10"
          value={searchQuery}
      ...
      <div className="flex flex-wrap items-center gap-3">
        {/* Status Filter */}
        <select 
          className="h-10 px-3 py-2 bg-black/40 border border-white/10 rounded-md text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
          value={statusFilter}
